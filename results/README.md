...
| `manifest.json` | `gpubench collect` | git SHA, image digests, GPU driver versions, experiment definition, price row, per-Job start/end/GPU count, GPU-hours and USD |
